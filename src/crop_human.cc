...
absl::Status RunGraph(std::string&& input_video_path) {
    mediapipe::CalculatorGraphConfig config = mediapipe::ParseTextProtoOrDie<mediapipe::CalculatorGraphConfig>(R"pb(
        ...
        node {
            ...
            output_stream: "DATA:throttled_input_stream"
        ...
        node {
            ...
            input_stream: "IMAGE:throttled_input_stream"
        ...
        node {
            ...
            output_stream: "RENDER_DATA:pose_detections_render_data"
            node_options: {
        ...
        node {
            ...
            input_stream: "IMAGE:throttled_input_stream"
            input_stream: "pose_detections_render_data"
        ...
        node {
            ...
            input_stream: "FRAME:annotated_image_stream"
            input_stream: "VIDEO_PRESTREAM:input_video_header"
            output_stream: "generated_video_header"
        }
        node {
            calculator: "OpenCvVideoEncoderCalculator"
            input_side_packet: "OUTPUT_FILE_PATH:output_video_path"
            input_stream: "VIDEO:annotated_image_stream"
            input_stream: "VIDEO_PRESTREAM:generated_video_header"
            node_options: {
