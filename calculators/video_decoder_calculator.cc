...
mediapipe::ImageFormat::Format GetImageFormat(int num_channels) {
...
class VideoDecoderCalculator : public mediapipe::CalculatorBase {
    public:
        static absl::Status GetContract(mediapipe::CalculatorContract* cc) {
            cc->InputSidePackets().Tag(kInputFilePathTag).Set<std::string>();
            cc->Outputs().Tag(kVideoTag).Set<mediapipe::ImageFrame>();
        ...
        absl::Status Open(mediapipe::CalculatorContext* cc) override {
            ...
            if (format_ == mediapipe::ImageFormat::UNKNOWN) {
                return mediapipe::InvalidArgumentErrorBuilder(MEDIAPIPE_LOC)
...
REGISTER_CALCULATOR(VideoDecoderCalculator);
